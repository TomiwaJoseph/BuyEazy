...
urlpatterns = [
    ...
    path('specific-category-and-price/', views.filter_price_and_product,
         name='filter_price_and_product'),
    path('add-to-wishlist/', views.add_to_wishlist, name='add_to_wishlist'),
    path('add-to-cart/', views.add_to_cart, name='add_to_cart'),
    path('load-more-products/', views.load_more_products,
    ...
    path('view-product/<slug:slug>',
         views.SingleProduct.as_view(), name='view_product'),
    path('save_review/', views.save_review, name='save_review'),
    path('shop/', views.shop, name='shop'),

    # Stripe
    path('shop/purchase/stripe/success/',
         views.SuccessView.as_view(), name="success"),
    path('shop/purchase/stripe/cancel/',
